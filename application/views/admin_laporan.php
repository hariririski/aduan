                                  ...
                                  <div >
                                    <table id="example" class="display responsive nowrap" style="width:100%">
                                        ...
                                        <tr>
                                             <td>1</td>
                                             <td>Semua Tahun</td>
                                             <td><a href="<?php echo site_url(); ?>detail_laporan?id=0"><button type="button" class="btn btn-primary">Detail</button></a></td>
                                         </tr>
                                        <?php
                                          $i=1;
                                        ...
                                        <tr>
                                             ...
                                             <td><a href="<?php echo site_url(); ?>detail_laporan?id=<?php echo $tahun->tahun; ?>"><button type="button" class="btn btn-primary">Detail</button></a></td>
                                         </tr>
                                        <?php } ?>
                                			</tbody>
                                		</table>
