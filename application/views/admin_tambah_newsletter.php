                                ...
                                <div class="list-single-main-item fl-wrap block_box " style="padding: 20px;">
                                  <div class="custom-form" style="padding: 20px;">
                                    <form action="<?php echo site_url(); ?>p_tindak_lanjut?id=<?php echo $detail->id_pengaduan; ?>&&id2=<?php echo $detail->id_pelapor; ?>" method="post" enctype="multipart/form-data">
                                      ...
                                      <div class="row">
                                        <div class="col-sm-12">
                                          <label style="padding: 10px;">Gambar<i class="fal fa-user" style="top: 50px;"></i></label>
                                          <input required type="text"   name="judul" placeholder="Gambar Newsletter" >
                                        </div>
                                        <div class="col-sm-12">
                                          <label style="padding: 10px;">URL Newsletter<i class="fal fa-user" style="top: 50px;"></i></label>
                                          <input type="text"   name="gambar" placeholder="Link URL Newsletter" >
                                        </div>
                                        <div class="col-sm-12">
                                          <label style="padding: 10px;">Url JS<i class="fal fa-user" style="top: 50px;"></i></label>
                                          <input type="text"   name="gambar" placeholder="Link URL JS" >
                                        </div>
