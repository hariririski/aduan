                                ...
                                <div class="list-single-main-item fl-wrap block_box " style="padding: 20px;">
                                  <div >
                                    <table class=" data" id="customers">
                                        ...
                                        <tr>
                                             <td><?php echo $i; ?></td>
                                             <td><?php echo $jenis_informasi->nama_jenis_informasi; ?></td>
                                             <td><a href="<?php echo site_url(); ?>lapor/detail_lapor/<?php echo $jenis_informasi->id_pengaduan; ?>"><button type="button" class="logout_btn color2-bg">Detail</button></a></td>
                                         </tr>
                                        <?php } ?>
                                			</tbody>
                                		</table>
