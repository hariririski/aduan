...
<header class="main-header">
    <!-- logo-->
    <a href="<?php echo site_url(); ?>" class="logo-holder" style="float: left;height: 80%;position: relative;top: 10px;"><img src="<?php echo site_url(); ?>assets/umum/images/logo.png" alt=""></a>
    <!-- logo end-->
    ...
    <div class="nav-holder main-menu">
        <nav>
            <ul class="no-list-style">
                ...
                <li>
                    <a href="<?php echo site_url(); ?>newsletter_pc">Newsletter</a>
                </li>
                <?php
                ...
                ?>
                <li>
                    <a href="<?php echo site_url(); ?>hp">Pindah Ke Tampilan Handphone</a>
                </li>
              <?php } ?>
            </ul>
        </nav>
